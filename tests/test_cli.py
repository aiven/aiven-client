...
def test_oauth2_client_remove() -> None:
    ...
    build_aiven_cli(aiven_client).run(
        args=["account", "oauth2-client", "remove", "a2313127", "--oauth2-client-id", oauth2_client_id]
    )
...
def test_oauth2_client_redirects_list() -> None:
    ...
    build_aiven_cli(aiven_client).run(
        args=["account", "oauth2-client", "redirects-list", "a2313127", "--oauth2-client-id", oauth2_client_id]
    )

    aiven_client.list_oauth2_client_redirects.assert_called_with("a2313127", oauth2_client_id)


def test_oauth2_client_redirects_create() -> None:
    aiven_client = mock.Mock(spec_set=AivenClient)
    oauth2_client_id = str(uuid.uuid4())
...
def test_oauth2_client_redirects_remove() -> None:
    aiven_client = mock.Mock(spec_set=AivenClient)
    oauth2_client_id = str(uuid.uuid4())

    aiven_client.remove_oauth2_client_redirect.return_value = {}
    ...
    aiven_client.remove_oauth2_client_redirect.assert_called_with("a2313127", oauth2_client_id, "123")
...
def test_oauth2_client_secrets_list() -> None:
    ...
    build_aiven_cli(aiven_client).run(
        args=["account", "oauth2-client", "secrets-list", "a2313127", "--oauth2-client-id", oauth2_client_id]
    )

    aiven_client.list_oauth2_client_secrets.assert_called_with("a2313127", oauth2_client_id)


def test_oauth2_client_secrets_create() -> None:
    aiven_client = mock.Mock(spec_set=AivenClient)
    oauth2_client_id = str(uuid.uuid4())
    ...
    build_aiven_cli(aiven_client).run(
        args=["account", "oauth2-client", "secrets-add", "a2313127", "--oauth2-client-id", oauth2_client_id]
    )

    aiven_client.create_oauth2_client_secret.assert_called_with("a2313127", oauth2_client_id)


def test_oauth2_client_secrets_remove() -> None:
    aiven_client = mock.Mock(spec_set=AivenClient)
    oauth2_client_id = str(uuid.uuid4())

    aiven_client.remove_oauth2_client_secret.return_value = {}
    ...
    aiven_client.remove_oauth2_client_secret.assert_called_with("a2313127", oauth2_client_id, "123")
