...
ssl.truststore.type=JKS
    ...
    @arg.service_name
    @arg.json
    def service__flink__table__list(self) -> None:
        """List Flink tables"""
        project_name = self.get_project()
        layout = [
            [
    ...
    @arg.json
    def service__flink__table__create(self) -> None:
    ...
    def service__flink__table__get(self) -> None:
        """Get a Flink table"""
        project_name = self.get_project()
        layout = [
            [
    ...
    @arg.service_name
    @arg("table_id", help="Table ID")
    def service__flink__table__delete(self) -> None:
        ...
        if response == {}:
            self.print_response({"message": f"Table with id {self.args.table_id} was deleted"})
        else:
            self.print_response(response)
    ...
    @arg.json
    def service__flink__job__create(self) -> None:
        """Create a Flink job"""
        project_name = self.get_project()
        layout = [
            [
    ...
    @arg.service_name
    @arg.json
    def service__flink__job__list(self) -> None:
        """List Flink jobs"""
        project_name = self.get_project()
        layout = [
            [
    ...
    def service__flink__job__get(self) -> None:
        """Get a Flink job"""
        project_name = self.get_project()
        layout = [
            [
    ...
    @arg.json
    @arg("job_id", help="Job ID")
    def service__flink__job__cancel(self) -> None:
        """Cancel a Flink job"""
        project_name = self.get_project()
