...
""".format(
    ...
    @arg.account_id
    @arg("--oauth2-client-id", help="OAuth2 client id", required=True)
    def account__oauth2_client__remove(self):
        """Remove an OAuth2 client."""

        oauth2_client = self.client.delete_oauth2_client(self.args.account_id, self.args.oauth2_client_id)

    @arg.json
    @arg.account_id
    @arg("--oauth2-client-id", help="OAuth2 client id", required=True)
    def account__oauth2_client__redirects_list(self):
    ...
    def account__oauth2_client__redirects_add(self):
    ...
    def account__oauth2_client__redirects_remove(self):
        """Add an allowed redirect URI to an OAuth2 client."""

        self.client.remove_oauth2_client_redirect(
    ...
    @arg.account_id
    @arg("--oauth2-client-id", help="OAuth2 client id", required=True)
    def account__oauth2_client__secrets_list(self):
    ...
    @arg.account_id
    @arg("--oauth2-client-id", help="OAuth2 client id", required=True)
    def account__oauth2_client__secrets_add(self):
        """List OAuth2 client secrets."""
    ...
    def account__oauth2_client__secrets_remove(self):
        """List OAuth2 client secrets."""

        oauth2_client_secrets = self.client.remove_oauth2_client_secret(
            self.args.account_id, self.args.oauth2_client_id, self.args.secret_id
        )
